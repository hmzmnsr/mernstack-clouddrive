...
const RecentFiles: React.FC = () => {
    return (
        <FlexContainer className='w-full flex-col'>
            <div className="px-8 pt-3 text-lg font-bold tracking-wide font-sans leading-loose">Recent Files</div>
            ...
            <div className='grid grid-cols-12 mt-3 bg-white'>
                ...
                <div className='col-span-3 w-full h-full flex items-center justify-center text-lg font-semibold'>Last Modified</div>
                <div className='col-span-2 w-full h-full flex items-center justify-center text-lg font-semibold'>Folder Name</div>
